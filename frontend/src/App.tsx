...
重點：${userMessage}`
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-gradient-to-br from-base-200 via-base-100 to-base-200 px-4 py-6 text-base-content lg:px-10 lg:py-10">
